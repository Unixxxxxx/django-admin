...
SECRET_KEY = 'django-insecure-p_my7^1+g_grln!(j#-dgijn@9av^=6#)&75!mz&xbl^b&zy9a'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*", "https://django-admin-3i8t.vercel.app/"]
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(LOG_DIR, 'django_filebeat.log'),
        },
    },
    'loggers': {
        'django': {
